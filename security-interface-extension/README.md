...
## GitHub branch
- To pick up the release version of the code, checkout the branch "security-extension-acs".  The release tag is: v21.10_SIE_REL1.0
...
The test suite consists of both automated and manual tests.  See the [Security Interface Extension ACS Users Guide](./security_extension_users_guide.md) for addition information.
